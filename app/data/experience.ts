...
export const EXPERIENCES: Experience[] = [
...

  {
    ...
    inlineDetails: [
      "Interviewed faculty candidates as part of the ECE department hiring process",
      "Evaluated teaching philosophy, communication clarity, and undergraduate engagement",
      "Provided structured feedback representing the undergraduate student perspective",
    ],
    fullDetails: [
       "Participated as an undergraduate interviewer in the UT Austin ECE faculty recruitment process",
      "Conducted one-on-one and panel interviews with faculty candidates focusing on teaching effectiveness and approachability",
      "Assessed candidates’ ability to communicate complex research ideas to undergraduate students",
      "Provided written and verbal feedback to the faculty hiring committee representing student perspectives",
      "Contributed to discussions on curriculum impact, mentoring style, and inclusivity in undergraduate education",
    ],
